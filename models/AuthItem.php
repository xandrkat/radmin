...
use xandrkat\radmin\controllers\AssignmentController;
use xandrkat\radmin\Module;
use Yii;
use yii\base\Model;
...
class AuthItem extends Model
{
        ...
        if (!Configs::authManager()->getRule($name)) {
            try {
                ...
                if ($rule instanceof Rule) {
                    ...
                    $this->addError('ruleName', Yii::t('radmin', 'Invalid rule "{value}"', ['value' => $name]));
                }
            } catch (Exception $exc) {
                $this->addError('ruleName', Yii::t('radmin', 'Rule "{value}" does not exists', ['value' => $name]));
            }
        }
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'type'        => Yii::t('radmin', 'Type'),
            'description' => Yii::t('radmin', 'Description'),
            'ruleName'    => Yii::t('radmin', 'Rule Name'),
