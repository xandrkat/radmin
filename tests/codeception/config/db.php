<?php
/**
 * This is the configuration file for the yii2-radmin unit tests.
...
$databases = [
    'mysql'  => [
        'dsn'      => 'mysql:host=127.0.0.1;dbname=radmin_admin_test',
        'username' => 'travis',
        'password' => '',
    ],
    'sqlite' => [
        //'dsn' => 'sqlite::memory:',
        'dsn' => 'sqlite:@runtime/radmin_admin_test.sqlite',
    ],
    'pgsql'  => [
        'dsn'      => 'pgsql:host=localhost;dbname=radmin_admin_test;port=5432;',
        'username' => 'postgres',
        'password' => 'postgres',
    ],
];
