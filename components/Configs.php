...
use Exception;
use xandrkat\radmin\BaseObject;
use Yii;
 ...
 *
 * ```
 * Yii::$container->set('xandrkat\radmin\components\Configs',[
 *     'db' => 'customDb',
 *     'menuTable' => 'admin_menu',
 * ]);
 * ```
...
class Configs extends BaseObject
{
    ...
    public static function instance()
    {
        if (self::$_instance === NULL) {
            $type = ArrayHelper::getValue(Yii::$app->params, 'radmin.admin.configs', []);
