...
use xandrkat\radmin\models\Assignment;
use xandrkat\radmin\models\searchs\Assignment as AssignmentSearch;
use Yii;
...
class AssignmentController extends Controller
{
    ...
    public function init()
    {
        ...
        if ($this->userClassName === NULL) {
            ...
            $this->userClassName = $this->userClassName ?: 'xandrkat\radmin\models\User';
        }
    }
