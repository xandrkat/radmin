...
/* @var $model xandrkat\radmin\models\Assignment */
...
$this->title = Yii::t('radmin', 'Assignment') . ' : ' . $userName;

$this->params['breadcrumbs'][] = ['label' => Yii::t('radmin', 'Assignments'), 'url' => ['index']];
